# Part 2 / Stage 14 · 特性与关键字全表 / 逐标准对账

- 路线图源文档: `第2部分-阶段14-特性与关键字全表.md` (在 `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/` 下找原始中文版)
...
```bash
ls src/cpp/part2_stage14_keywords_and_features_index
```
