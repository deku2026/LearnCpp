...
```bash
ls src/cpp/part4_engineering_system
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part4/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part4/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part4/section01/<item_slug>
```
