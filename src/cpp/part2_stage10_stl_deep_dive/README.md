# Part 2 / Stage 10 · STL 深潜 (容器 / 迭代器 / 算法 / 现代工具类型 / Ranges / C++23 新设施)

- 路线图源文档: `第2部分-阶段10-STL深潜.md` (在 `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/` 下找原始中文版)
...
```bash
ls src/cpp/part2_stage10_stl_deep_dive
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part2/stage10/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part2/stage10/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part2/stage10/section01/<item_slug>
```
