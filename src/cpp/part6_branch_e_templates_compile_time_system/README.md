# Part 6 · Branch E · 模板与编译期系统 (深水 TMP)

- 路线图源文档: `第6部分-支线E-模板与编译期系统.md` (在 `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/` 下找原始中文版)
- 主路线索引: `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/Cpp-Modern-完整学习路线图-C++23.md`

## 目标

深水模板: SFINAE / Concepts 偏序 / 类型擦除 / 表达式模板 / 多态光谱 / C++23 tuple-like / common_reference for reference_wrapper / implicit lifetime traits.

## 子目录 (sectionNN_xxx, 按文档大项顺序)

```bash
ls src/cpp/part6_branch_e_templates_compile_time_system
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part6/e/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part6/e/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part6/e/section01/<item_slug>
```
