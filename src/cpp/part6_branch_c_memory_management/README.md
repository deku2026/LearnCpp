...
```bash
ls src/cpp/part6_branch_c_memory_management
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part6/c/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part6/c/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part6/c/section01/<item_slug>
```
