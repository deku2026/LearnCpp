# Part 2 / Stage 06 · 模板与泛型编程

- 路线图源文档: `第2部分-阶段6-模板与泛型编程.md` (在 `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/` 下找原始中文版)
- 主路线索引: `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/Cpp-Modern-完整学习路线图-C++23.md`

## 目标

C++ 泛型全套: 模板 / SFINAE / Concepts / CRTP / TMP. STL 的底座, 库设计的核心.

## 子目录 (sectionNN_xxx, 按文档大项顺序)

```bash
ls src/cpp/part2_stage06_templates_and_generics
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part2/stage06/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part2/stage06/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part2/stage06/section01/<item_slug>
```
