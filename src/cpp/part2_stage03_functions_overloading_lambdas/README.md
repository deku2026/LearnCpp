# Part 2 / Stage 03 · 函数 / 重载 / Lambda

- 路线图源文档: `第2部分-阶段3-函数-重载-lambda.md` (在 `C:/MyFile/ArcForges/ArchitectureDesign/CppStudy/` 下找原始中文版)
...
```bash
ls src/cpp/part2_stage03_functions_overloading_lambdas
```
...
4. 跑这一个 topic:
   ```
   build/windows-debug/bin/learn_cpp.exe part2/stage03/sectionNN/item_slug
   ```
...
每个 `.cpp` 在 `learn::topic<...>` 里的 id 形如 `part2/stage03/sectionMM/<item_slug>`,
跟文件路径一一对应, 例:
```
part2/stage03/section01/<item_slug>
```
