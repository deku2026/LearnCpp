...
namespace learn_cpp::part2_stage06::section01 {

TEST(part2_stage06_section01, partial_template_specialization) {
    GTEST_SKIP() << "todo: partial_template_specialization";
}
