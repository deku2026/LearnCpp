...
namespace learn_cpp::part6_branch_e::section06 {

TEST(part6_branch_e_section06, small_buffer_optimization_in_erasure) {
    GTEST_SKIP() << "todo: small_buffer_optimization_in_erasure";
}
