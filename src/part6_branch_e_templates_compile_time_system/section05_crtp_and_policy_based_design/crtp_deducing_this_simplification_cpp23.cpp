...
namespace learn_cpp::part6_branch_e::section05 {

TEST(part6_branch_e_section05, crtp_deducing_this_simplification_cpp23) {
    GTEST_SKIP() << "todo: crtp_deducing_this_simplification_cpp23";
}
