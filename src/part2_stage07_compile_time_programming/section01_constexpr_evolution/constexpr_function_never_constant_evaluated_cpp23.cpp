...
namespace learn_cpp::part2_stage07::section01 {

TEST(part2_stage07_section01, constexpr_function_never_constant_evaluated_cpp23) {
    GTEST_SKIP() << "todo: constexpr_function_never_constant_evaluated_cpp23";
}
