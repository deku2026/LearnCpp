...
namespace learn_cpp::part2_stage03::section04 {

TEST(part2_stage03_section04, deducing_this_recursive_lambda_cpp23) {
    GTEST_SKIP() << "todo: deducing_this_recursive_lambda_cpp23";
}
