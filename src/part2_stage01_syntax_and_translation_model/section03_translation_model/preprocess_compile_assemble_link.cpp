...
namespace learn_cpp::part2_stage01::section03 {

TEST(part2_stage01_section03, preprocess_compile_assemble_link) {
    GTEST_SKIP() << "todo: preprocess_compile_assemble_link";
}
