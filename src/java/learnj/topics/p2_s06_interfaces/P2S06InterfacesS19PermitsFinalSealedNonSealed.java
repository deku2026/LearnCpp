 ...
 */
public final class P2S06InterfacesS19PermitsFinalSealedNonSealed {
    static {
        TopicRegistry.register("part2/stage06/s19/permits_final_sealed_non_sealed", args -> {
            // practice: `permits` / `final` / `sealed` / `non-sealed`
            return 0;
        });
    }

    private P2S06InterfacesS19PermitsFinalSealedNonSealed() {
    }
}
