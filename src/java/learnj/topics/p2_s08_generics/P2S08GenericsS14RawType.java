 ...
 */
public final class P2S08GenericsS14RawType {
    static {
        TopicRegistry.register("part2/stage08/s14/raw_type", args -> {
            // practice: raw type 与未检查转换
            return 0;
        });
    }

    private P2S08GenericsS14RawType() {
    }
}
