 ...
 */
public final class P6EJitAotS15JepAotMethodProfilingJdk {
    static {
        TopicRegistry.register("part6/branch_e/s15/jep_aot_method_profiling_jdk", args -> {
            // practice: JEP 515：AOT Method Profiling（JDK 25）
            return 0;
        });
    }

    private P6EJitAotS15JepAotMethodProfilingJdk() {
    }
}
