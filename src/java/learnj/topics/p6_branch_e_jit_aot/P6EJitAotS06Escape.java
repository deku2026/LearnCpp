 ...
 * Step     : s06
 * Item     : escape
 * Topic id : part6/branch_e/s06/escape
 * Heading  : 逃逸分析与标量替换
 * <p>
 * TODO: read the JavaStudy section, write a minimal runnable demo,
 *       then replace this empty body with real practice code.
 */
public final class P6EJitAotS06Escape {
    static {
        TopicRegistry.register("part6/branch_e/s06/escape", args -> {
            // practice: 逃逸分析与标量替换
            return 0;
        });
    }

    private P6EJitAotS06Escape() {
    }
}
