 ...
 */
public final class P8NativeS12FfmJniBytebufferUnsafe {
    static {
        TopicRegistry.register("part8/native/s12/ffm_jni_bytebuffer_unsafe", args -> {
            // practice: FFM vs JNI vs ByteBuffer vs Unsafe
            return 0;
        });
    }

    private P8NativeS12FfmJniBytebufferUnsafe() {
    }
}
